...
import com.dariel94.android.pokeapp.data.api.pokeapi.model.ResourcesResponse
import javax.inject.Inject

class GenerationsRemoteDataSource @Inject constructor(
    private val pokeApi: PokeApi
) {
    suspend fun getGenerations(): ResourcesResponse {
        return pokeApi.getGenerations()
    }
}